...
public class CoffeeTinGame {
    ...
    public static final String[] BeansBag = new String[30];
    static {
        int blueCount = 0;
        int greenCount = 0;
        int spaceCount = 0;
    ...
    public static char getBean(char[]BeansBag, char GREEN, char BLUE) {
        // the assignment says that I need to It takes as input an array of beans and a bean type (B or G) and
        // looks inside the array to find and return a randomly-selected bean that matches the bean type.
        // codes here
    ...
    private static char takeOne(char[] tin) {
        // non-javadocs compliant: we kinda replace
        int ran_bin_number = randInt();
...
// Update 8 (8.55 Mar 16 '23): The takeOne procedue has been modified to take randInt. (Side: haven't test yet)
```
